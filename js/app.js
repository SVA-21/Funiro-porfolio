(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".controls-slider-main .slider-arrow__prev",
                nextEl: ".controls-slider-main .slider-arrow__next"
            }
        });
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                if (targetElement.classList.contains("menu__line")) targetElement.closest(".menu__item").classList.toggle("_hover");
                if (!targetElement.closest(".menu__item")) itemMenu.forEach((element => {
        ...
        const furniture = document.querySelector(".furniture__block");
        if (furniture && !isMobile.any()) {
            ...
            function setMouseGalleryStyle() {
                let furnitureColumnsWidth = 0;
                furnitureColumn.forEach((element => {
                    furnitureColumnsWidth += element.offsetWidth;
                }));
                const furnitureDifferent = furnitureColumnsWidth - furniture.offsetWidth;
            ...
            furniture.addEventListener("mousemove", (function(e) {
                const furnituretWidth = furniture.offsetWidth;
                const coordX = e.pageX - furnituretWidth / 2;
                coordXprocent = coordX / furnituretWidth * 200;
